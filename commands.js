...
//1. Create collection of scavengers
db.createCollection('scavengers')

//2. Add scavengers to collection
...
//3. Find all scavengers who joined after December 31, 2011
db.scavengers.find({joined: {$gte: new Date('<2011-12-31>')}})

//4. Find scavengers who captured Thanoceros
db.scavengers.find({captured: {name: 'Thanoceros'}})

//5. Find scavengers who captured bounties worth more than $11000
db.scavengers.find({captured: {reward: {$gte: 11000}}})

//6. Find unarmed scavengers
